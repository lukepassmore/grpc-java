...
(function (global, factory) { /* global define, require, module */
  ...
  $root.Earthquake = (function () {
     ...
     * @implements IECsv
     * @constructor
     * @param {IECsv=} [properties] Properties to set
     */
     ...
     * @memberof Earthquake
     * @static
     * @param {IECsv} message Earthquake message or plain object to encode
  ...
  $root.Earthquakes = (function () {
     ...
     * @property {Array.<IECsv>|null} [records] Earthquakes records
     */
    ...
    /**
     * Earthquakes records.
     * @member {Array.<IECsv>} records
     * @memberof Earthquakes
     * @instance
     */
    Earthquakes.prototype.records = $util.emptyArray;
    ...
    Earthquakes.encode = function encode(message, writer) {
      ...
      if (message.records != null && message.records.length)
        for (var i = 0; i < message.records.length; ++i)
          $root.Earthquake.encode(message.records[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
      return writer;
    };
        ...
        switch (tag >>> 3) {
          case 1:
            if (!(message.records && message.records.length))
              message.records = [];
            message.records.push($root.Earthquake.decode(reader, reader.uint32()));
            break;
          default:
            reader.skipType(tag & 7);
            break;
    ...
    Earthquakes.verify = function verify(message) {
      ...
      if (message.records != null && message.hasOwnProperty("records")) {
        ...
        for (var i = 0; i < message.records.length; ++i) {
          var error = $root.Earthquake.verify(message.records[i]);
          if (error)
    ...
    Earthquakes.fromObject = function fromObject(object) {
      ...
      if (object.records) {
        if (!Array.isArray(object.records))
          throw TypeError(".Earthquakes.records: array expected");
        message.records = [];
        for (var i = 0; i < object.records.length; ++i) {
          if (typeof object.records[i] !== "object")
            throw TypeError(".Earthquakes.records: object expected");
          message.records[i] = $root.Earthquake.fromObject(object.records[i]);
        }
      }
      return message;
    };
    ...
    Earthquakes.toObject = function toObject(message, options) {
      ...
      if (message.records && message.records.length) {
        ...
        for (var j = 0; j < message.records.length; ++j)
          object.records[j] = $root.Earthquake.toObject(message.records[j], options);
      }
      return object;
    };
